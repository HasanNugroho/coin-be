...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/admin/pockets": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Limit (default: 10, max: 1000)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
        ...
        "/v1/admin/pockets/{user_id}": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "System pocket details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateSystemPocketRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "System pocket created successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/v1/dashboard/sync": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Daily summaries synced successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreatePlatformRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/platforms/active": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Active platforms retrieved successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/v1/platforms/type/{type}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Platform type (BANK, E_WALLET, CASH, ATM)",
                        "name": "type",
                        "in": "query",
                        "required": true
                    },
        ...
        "/v1/platforms/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Platform update details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdatePlatformRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/pocket-templates": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Pocket templates retrieved successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Pocket template details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreatePocketTemplateRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Pocket template created successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/v1/pocket-templates/active": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Active pocket templates retrieved successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                ...
                "parameters": [
                    {
                        ...
                        "type": "string",
                        "description": "Pocket Template Type",
                        "name": "type",
                        "in": "path",
                        "required": true
                    },
        ...
        "/v1/pocket-templates/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Pocket Template ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Pocket template retrieved successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "Invalid pocket template ID",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "404": {
                        "description": "Pocket template not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Pocket template update details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdatePocketTemplateRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Pocket template updated successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "Pocket template deleted successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreatePocketRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/pockets/active": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Active pockets retrieved successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/v1/pockets/main": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Main pocket retrieved successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "404": {
                        "description": "Main pocket not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/v1/pockets/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Pocket update details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdatePocketRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/transactions/pocket/{pocket_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/v1/user-categories": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create User Category Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateUserCategoryRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/user-categories/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update User Category Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateUserCategoryRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/user-platforms": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Sort by (alias_name, balance, created_at)",
                        "name": "sort_by",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "dto.UpdatePocketTemplateRequest": {
            "type": "object",
            "properties": {
                "background_color": {
                    "type": "string",
