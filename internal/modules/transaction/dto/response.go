...
type TransactionResponse struct {
	...
	UserPlatformFrom *string    `bson:"user_platform_from"    json:"user_platform_from,omitempty"`
	UserPlatformTo   *string    `bson:"user_platform_to"      json:"user_platform_to,omitempty"`
