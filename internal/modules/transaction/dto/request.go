...
type CreateTransactionRequest struct {
	...
	UserPlatformFrom string  `json:"user_platform_from" validate:"omitempty,len=24,hexadecimal"`
	UserPlatformTo   string  `json:"user_platform_to" validate:"omitempty,len=24,hexadecimal"`
